...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-08-2023 a las 00:54:09
...
(4, 'jorge@gmail.com', NULL, 115, 'holaaaaaaaaaaaaaaaa', '2023-08-19', '09:35:00', 'active'),
(5, 'jorge@gmail.com', NULL, 115, 'olaaaaaaaaaaaaaaa', '2023-08-19', '09:37:00', 'active');
...
('Cesar@astro.sv', 'Cesar@astro.sv.png', '123', 'Cesar', 'Marquez', '+503 75148248', 2),
...
('jorge@gmail.com', 'Jorge Luis', 'Echeverria', '123', '+503 7763-565', 3, 'lawyer2.png'),
...
--
ALTER TABLE `comments`
  ADD CONSTRAINT `comment-reporter` FOREIGN KEY (`id_reporter`) REFERENCES `reporter` (`Email`) ON DELETE SET NULL ON UPDATE CASCADE,
...
--
ALTER TABLE `news`
  ADD CONSTRAINT `news-journalist` FOREIGN KEY (`id_reporter`) REFERENCES `reporter` (`Email`) ON DELETE SET NULL ON UPDATE CASCADE;
COMMIT;
