...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-08-2023 a las 04:14:54
...
(3, 'rubencitonieto005@gmail.com', 115, 'er', '2023-08-16', 'active');
...
ALTER TABLE `comments`
  ...
  ADD CONSTRAINT `news-comment` FOREIGN KEY (`id_new`) REFERENCES `news` (`id_news`);
