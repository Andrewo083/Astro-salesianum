                  ...
                  <div class="flex flex-row items-center pb-4">
                      ...
                      <div class="flex pt-2  text-sm text-gray-400">
                        ...
                        <div class="mt-4 mr-0 mb-0 ml-0 mdpt-0 pr-0 pb-0 pl-14 flex items-center sm:space-x-6 gap-2 sm:pl-0 sm:mt-0">
                          ...
                          <a  href="./PHP/deletenews.php?new=<?php echo $row['id_news']?>" type="submit"  name="delete" class="bg-red-800 pt-2 pr-6 pb-2 pl-6 text-lg font-medium text-gray-100 transition-all
